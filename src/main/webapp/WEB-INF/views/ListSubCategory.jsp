							...
							<div class="card">
								...
								<div class="card-body">
									...
									<table class="table datatable datatable-table table-hover" id="sub_category">
										...
										<tbody>
											<c:forEach items="${allSubCategoryList}" var="s">
												<tr>
							                        <td>${s[3]}</td>
							                        <td>${s[1]}</td>
													<td><a href="editsubCategory?subCategoryId=${s[0]}">Edit</a> |<a href="deletesubCategory?subCategoryId=${s[0]}">Delete</a>|
													 <a href="viewsubCategory?subCategoryId=${s[0]}">View</a>
													 </td>
												</tr>
											</c:forEach>
										</tbody>
