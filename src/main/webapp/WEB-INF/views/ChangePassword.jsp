...
<head>
  ...
  <title>NR Bazaar / Change Password </title>
                  ...
                  <form action="updatepassword" method="post" class="row g-3 needs-validation" novalidate>
                    ...
                    <div class="col-12">
					 ...
					 <div class="col-12">
                      ...
                      <input type="number" name="otp" class="form-control" id="otp" placeholder="Enter your otp" required>
                    ...
                    <div class="col-12">
                       <input class="btn btn-primary w-100" type="submit" value="Update Password"/> 
