...
public interface SubCategoryRepository extends JpaRepository<SubCategoryEntity,Integer>{
	...
	@Query(value="select sc.*,c.category_name from sub_category sc,category c where sc.category_id = c.category_id and sc.sub_category_id = :subCategoryId",nativeQuery = true)
